...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    title: 'ノードを追加する',
    description:
      '「+ ノード追加」から論文名や手法名を入力します（例: Transformer, GPT-2）。追加後はすぐにグラフ上に表示されます。',
  },
  {
    id: 'connect',
    title: 'ノード同士を結ぶ',
    description:
      '「2点選択」「ドラッグ結線」に加え、「名前で結線」なら論文名を入力して接続できます（例: Word2Vec → Transformer）。線は辺の中点同士を結びます。不要な線はクリックで選択し、削除ボタンまたは Delete キーで消せます。',
  },
  {
    id: 'detail',
    title: '詳細・メモ・理解度',
    description:
      'ノードをクリックすると右側に詳細パネルが開きます。理解度（◎○△×）、関連/非関連、メモを編集して保存できます（例: Transformer の概要・RAG 調査メモ）。背景をクリックまたは Esc で閉じられます。',
  },
  {
    id: 'groups',
    title: 'グループで共有',
